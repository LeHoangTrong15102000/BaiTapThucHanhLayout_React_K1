...
export default class SelectCar extends Component {
  ...
  renderIcon = () => {
    return dataFeatures.map((item, index) => {
      return (
        ...
        <div onClick={() => {this.changeColorCar(item)}} style={{cursor: 'pointer'}} className="row mt-1 border border-color-default m-3" key={index}>
          <div className="col-2">
            <img
              className="p-3"
              style={{ width: "100%" }}
  ...
  renderWheels = () => {
    return dataWheels.map((item, index) => {
      return (
        <div  onClick={() => {}} style={{cursor: 'pointer'}} className="row mt-1 border border-color-default m-3" key={index}>
          <div className="col-2">
            <img
              className="p-3"
              style={{ width: "100%" }}
